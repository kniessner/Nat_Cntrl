	  ...
	  _createClass(Control_Board, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.getClientHeader, className: 'btn btn-default', type: 'button', 'aria-label': 'button' },
	          ' Client Header'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.getFolder, className: 'btn btn-default', type: 'button', 'aria-label': 'button' },
	          'Folder'
	        ),
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { 'class': 'btn btn-default-alt', type: 'submit', value: 'Submit' })
	        ),
	        _react2.default.createElement(
	          'ul',
	          { className: 'stream' },
