	...
	var Control_Board = function (_React$Component) {
	  ...
	  _createClass(Control_Board, [{
	    ...
	    value: function _handleMessageEvent() {
	      ...
	      this.props.socket.on('sys', function (inboundMessage) {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              this.state.messages.map(function (object, i) {
	                ...
	                switch (object.name) {
	                  case 'client_header':
	                    return _react2.default.createElement(Item_Collection, { data: object, key: i });
	                    break;
	                  case 'error':
	                    return _react2.default.createElement(Item_Error, { data: object, key: i });
	                    break;
	                  case 'message':
