	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_puiReactIconography.Icon, { src: 'menu', style: {
	              color: "white"
	            } })
	        ),
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'nav_bar_expand', expanded: this.state.expanded, onEntered: function onEntered() {
	              return console.log('onEntered');
	            }, onExited: function onExited() {
	              return console.log('onExited');
	            } },
	          _react2.default.createElement('nav', { className: 'sub_nav' })
	        )
	      );
	    }
	  }]);
