	...
	var Control_Board = function (_React$Component2) {
	  ...
	  function Control_Board(props) {
	    ...
	    _this2.handleOnSubmit = function (e) {
	      ...
	      _this2.setState({ messages: allMessages });
	  ...
	  _createClass(Control_Board, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.socket.on('connect', function () {
	        _this3.setState({ connection: true });
	    ...
	    value: function _handleMessageEvent() {
	      ...
	      this.props.socket.on('display', function (inboundMessage) {
	        ...
	        _this4.setState({ messages: allMessages });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'header bg-neutral-11 box-shadow-1', header: 'Commander', subtitle: 'Execute Shell Commands', actions: _react2.default.createElement(
	              'div',
	              null,
	              ' ',
	              _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_puiReactInputs.Input, { search: true, name: 'content', value: this.state.input, onChange: this.handleOnChange, label: 'Run CMD', placeholder: 'GET SERVERINFOS' }),
