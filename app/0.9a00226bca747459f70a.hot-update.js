	...
	var Chat = function (_React$Component) {
	  ...
	  _createClass(Chat, [{
	    ...
	    value: function componentWillMount() {
	      var example = {
	        'from': 'you:' + window.location.hostname,
	        'title': 'testing',
	        'msg': 'you are online'
	      };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'header bg-neutral-11 box-shadow-1', header: 'Messanger', subtitle: 'Write with someone', actions: _react2.default.createElement(
	              'div',
	              null,
	              ' ',
	              _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_puiReactInputs.Input, { search: true, name: 'content', value: this.state.input, onChange: this.handleOnChange, label: 'Send a message', placeholder: 'Say something' }),
